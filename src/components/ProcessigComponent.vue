    ...
    <div class="gradient-cards">
        <div class="custom_cards">
            <div class="container-card bg-green-box">
                ...
                <h2 class="card-title mt-3">Zero-cost Possibilities</h2>
        ...
        <div class="custom_cards">
            <div class="container-card bg-white-box">
                ...
                <h2 class="card-title mt-3">Multi-Asset Collateral</h2>
        ...
        <div class="custom_cards">
            <div class="container-card bg-yellow-box">
                ...
                <h2 class="card-title mt-3">Get Yield on Deposits</h2>
        ...
        <div class="custom_cards">
            <div class="container-card bg-blue-box">
                ...
                <h2 class="card-title mt-3">Get up to 11x Leverage</h2>
